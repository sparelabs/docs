...
<Update label="August 7, 2025" description="Driver App v2.72 & Behavior Tracking Updates">
  ## Improved Driver Behavior Tracking
  
  We've refined how the system tracks driver behavior during breaks to be more accurate and fair. Previously, drivers who were idle before a scheduled break might incorrectly trigger behavior alerts. Now the system properly recognizes when drivers are appropriately waiting for their break time and won't flag this as problematic behavior.
  
  This improvement helps ensure that driver performance metrics accurately reflect actual service issues rather than normal operational patterns.
