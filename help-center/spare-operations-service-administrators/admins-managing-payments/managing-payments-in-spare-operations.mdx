...
## How We Manage Payments in Spare

We allow agencies to customize the payment methods each service can accept. Agencies can now create custom in-vehicle payment methods, like "Ticket" or "Monthly Pass". We call these Payment Method Types. 
