...
## IntroductionSpare is in the process of rolling out new and exciting features regarding Spare Pay. These features require that your agency’s Stripe configuration in Spare is set to “Connect” and not “Manual”. Below are some FA
