...
[Creating Time Rules](https://help.sparelabs.com/en/articles/8994601-time-rules)
...
## Creating a New ZoneEvery service needs to have an operational zone created.  There is no limit to the number of Zones you can create in a 
