...
An authorized access link will be sent to the specified recovery email address every 12 hours. This link will connect to the most recently generated backup for as long as the link is active. 
...
Driver-specific backups can also be accessed by logging in to a web app. 
...
1. Under Edit Backup Settings Detail, fill in the necessary information. 
