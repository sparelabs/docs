...
- What are the types of flexibilities, and what each of the types does?
- How are the flexibilities correlated?
- How do I set up the flexibilities for my service?
...
Decide what your focus should be on service efficiency, rider experience, etc.
