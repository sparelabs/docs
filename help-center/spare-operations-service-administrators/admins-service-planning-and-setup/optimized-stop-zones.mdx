...
# Step 1: Selecting Optimized Stop CandidatesWhen a rider is in an **Optimized Stop Zone**, the system runs a smart selection process to find a set of nearby stops that balance rider convenience with operational efficiency.
...
# Step 2: Choosing the Optimized StopsOnce a list of optimized stop candidates has been created:
