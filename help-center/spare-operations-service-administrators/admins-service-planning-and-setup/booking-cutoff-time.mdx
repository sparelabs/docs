...
description: "Learn how to configure booking cutoff times to ensure rides are booked with adequate fulfillment time"
---
...
## How to set up the Booking Cutoff Time

From **Spare Operations**, go to **Service Planning** and select **Services**. Go to the **Service Settings**.
...
## Setting the start of your "Service Day"

Your service may operate until 3am, and so you'll need to specify this in Spare Operations so we ensure that rides aren't booked between 12am-3am when they shouldn't be. You can do this in Settings > General > Organization with the "Service Day Start Time": 
