---
title: "Duty Delays"
description: "Learn about duty delays, how to review them, and understand the different types and resolved reasons for operational delays."
---

> **Note:** This feature is in early access and only accessible to users with Administrator and Operations Manager permissions. Talk to your Spare Representative to learn more.

## What is a Duty Delay?

A duty delay is an event that pushes back the ETA of an upcoming trip on a driver's manifest. This can be a vehicle breakdown, unexpected traffic, or a driver idling between stops. Spare records these events on the Duty Delays table. 
