...
description: "Overview of available Lyft fleet products including Regular Lyft, Wait & Save, XL, Assisted, and WAV options"
---
...
Lyft Wait and Save offers up to 10-20% lower cost compared to regular Lyft in exchange for an increased wait time. These rides are not shared and the wait time can range from 0-15 minutes depending on Lyft's algorithm. **Note that it's not possible to book scheduled rides** for Lyft Wait and Save.
...
Drivers can also help load and unload light mobility devices (such as canes, walkers, crutches, and foldable wheelchairs).

> **Note:** Only available in select regions. Please check with your Spare Representative.
