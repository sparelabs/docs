...
Note that you must already be an **Uber for Business** customer for the steps below to work.

1. Login to your Uber for Business dashboard
...
If you are not an Uber 4 Business customers **please reach out to your Spare representativ**e.
