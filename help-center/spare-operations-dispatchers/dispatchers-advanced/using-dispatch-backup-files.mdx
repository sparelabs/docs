...
## About this FeatureDispatch Backup Files provide the dispatch team with a redundancy for situations where Spare may be unavailable. 
...
## Accessing the Backup File**Open the Access 
...
## Backup File Tabs**Request Data**: The first tab includes all upcoming trips and their statuses. 
