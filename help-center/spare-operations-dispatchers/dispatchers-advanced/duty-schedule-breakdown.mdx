...
# OverviewThe Duty Schedule Breakdown provides a comprehensive look at the upcoming schedules for drivers, detailing how the "Spare Engine" predicts time will be spent. It covers various aspects of a driver's day, from trips planned to the specifics of each duty period.

## Understanding the Duty ScheduleUpon viewing the duty schedule for upcoming duties, the interface will display a breakdown of predicted activities. 
...
## Real-Time UpdatesOnce the duty begins, the section labeled "Duty Time 

Travel" will update in real-time to reflect the ongoing activities, replacing the initial predictive schedule.

## Current LimitationsThis feature is currently available only for viewing upcoming duties. 
